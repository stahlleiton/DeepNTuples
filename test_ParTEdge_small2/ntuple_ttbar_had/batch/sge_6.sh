...
export JOB=6
export NTUPLEOUTFILEPATH=/eos/cms/store/group/phys_btag/ParticleTransformer/JustATest/Wed_112853_test_ParTEdge_small2/ntuple_ttbar_had/output/ntuple_ttbar_had_6.root
