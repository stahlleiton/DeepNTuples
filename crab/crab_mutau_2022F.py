...
config.General.requestName = 'mutau_muon_2022F'
config.General.workArea = 'crab_projects'
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../DeepNtuplizer/production/DeepNtuplizer_mutau.py'
...
config.Data.outLFNDirBase = "/store/group/phys_btag/ParT_2024/Data_samples/mutau/2022F"
