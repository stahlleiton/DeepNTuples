...
private:
    ...
    //track info
    unsigned int   n_jetNTracksEtaRel_;        // tracks associated to jet for which trackEtaRel is calculated
    unsigned int   n_jetNSelectedTracks_;
    ...
    //SV info
    unsigned int   n_StoredVertices_;
