...
def doSub():
    ...
    parser.add_argument('--walltime',default='28800',help='set job wall time in seconds')
    parser.add_argument('--maxsize',default='15000',help='set maximum allowed size of output ntuple')
