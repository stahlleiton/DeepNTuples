...
export JOB=2
export NTUPLEOUTFILEPATH=/eos/cms/store/group/phys_btag/ParticleTransformer/JustATest/Wed_110513_test_ParTEdge_small/ntuple_ttbar_had/output/ntuple_ttbar_had_2.root
